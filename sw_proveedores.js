...
// v6c-2: Network-first (siempre busca actualización, cache solo offline fallback)
const CACHE_NAME = 'yumana-prov-v6c-2';
const ASSETS = [
...
self.addEventListener('fetch', e => {
  ...
  // HTML principal: SIEMPRE network-first
